...
#[allow(dead_code)]
pub fn save_neuron_as_image(neuron: &Neuron, name: impl Into<String>) {
	let name_into = name.into();
	let dimension = f32::sqrt(neuron.weights.len() as f32) as u32;
	// TODO: Fix this naming and code
	let neuron_2d = neuron
		.weights
